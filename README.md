...
- PowerHist.py
  ...
  More details could be found here: https://github.com/Michil783/PowerHist/PowerHist.md

- MQTT-to-DB.py
  Application connecting to MQTT broker and getting data from Tasmota Power meter reader to insert into database
  More details could be found here: https://github.com/Michil783/PowerHist/MQTT-to-DB.md
...
- PowerStation
  ...
  More details could be found here: https://github.com/Michil783/PowerHist/PowerStation.md
